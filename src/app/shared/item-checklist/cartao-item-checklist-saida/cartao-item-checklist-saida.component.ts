...
export class CartaoItemChecklistSaidaComponent implements OnInit, OnChanges {
  ...
  atualizarFormulario(): void {
    this.formulario.get('status')?.patchValue(this.item.statusSaida);
    this.formulario.get('observacao')?.patchValue(this.item.observacaoSaida);
    this.desabilitarFormulario();
  }

  desabilitarFormulario() {
    if (this.statusChecklist !== 'ENTRADA_PREENCHIDO') {
